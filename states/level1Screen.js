...
(function (RabbitRunGame) {
    var Level1Screen = (function (_super) {
        __extends(Level1Screen, _super);
        function Level1Screen() {
            return _super.call(this) || this;
            //console.log('Level1Screen');
        }
        Level1Screen.prototype.preload = function () {
            this.assets = {};
            this.tween = {};
        ...
        Level1Screen.prototype.createNewBullet = function () {
        ...
        Level1Screen.prototype.create = function () {
            //console.log('create');
            ...
            //
            this.assets.go_Total_Score_Txt = this.game.add.bitmapText(30, 320, 'nayupixelRegular', 'X ' + String((this.localVars.l1_Player.lifesCount * RabbitRunGame.Constants.GAME_LEVEL1.LIFE_SCORE) +
                ...
                (RabbitRunGame.Constants.GAME_LEVEL1.TOTAL_LEVEL_TIME_SCORE - (this.localVars.l1_Player.carrotsCount * RabbitRunGame.Constants.GAME_LEVEL1.SUBTRACT_TIME_SCORE))), 60);
        ...
        Level1Screen.prototype.updateLifeCount = function () {
        ...
        Level1Screen.prototype.update = function () {
        ...
        Level1Screen.prototype.render = function () {
            this.game.debug.text(String(this.game.time.fps), 2, 34, "#00ff00", "60px Arial");
        };
        //-----------------------------------------------------------------------------------------------
        Level1Screen.prototype.addGameEvents = function () {
        ...
        Level1Screen.prototype.touchDown = function () {
        ...
        Level1Screen.prototype.upPressed = function () {
            // console.log('Jump');
            this.jumpStart();
        };
        Level1Screen.prototype.spacebarPressed = function () {
            this.shootFire();
        };
        Level1Screen.prototype.jumpStart = function () {
        ...
        Level1Screen.prototype.shootFire = function () {
        ...
        //-----------------------------------------------------------------------------------------------
        Level1Screen.prototype.hitWater = function (player, tile) {
        ...
        Level1Screen.prototype.hitGate = function (player, gate) {
            console.log("hitGate");
            if (player.key == 'ALS_Player') {
                player.frame = 1;
                player.body.enable = false;
        ...
        Level1Screen.prototype.playerPositionTween = function (player, gate) {
        ...
        Level1Screen.prototype.playerPositionTweenFinished = function () {
        ...
        Level1Screen.prototype.playerScaleTween = function (player) {
        ...
        Level1Screen.prototype.playerScaleTweenFinished = function () {
            console.log("we are here");
            this.assets.l1_Player_Winning.alpha = 0;
        };
        Level1Screen.prototype.gateClosed = function () {
            ...
            this.assets.go_Total_Score_Txt.text = 'X ' + String((this.localVars.l1_Player.lifesCount * RabbitRunGame.Constants.GAME_LEVEL1.LIFE_SCORE) +
                (this.localVars.l1_Player.carrotsCount * RabbitRunGame.Constants.GAME_LEVEL1.CARROT_SCORE) +
                (this.localVars.l1_Player.coinsCount * RabbitRunGame.Constants.GAME_LEVEL1.COIN_SCORE) +
        ...
        Level1Screen.prototype.collectCoins = function (player, coin) {
            this.localVars.l1_Player.coinsCount++;
            this.assets.l1_Coin_Txt.text = 'X ' + String(this.localVars.l1_Player.coinsCount);
            coin.kill();
        };
        Level1Screen.prototype.collectRubies = function (player, ruby) {
            this.localVars.l1_Player.rubiesCount++;
            this.assets.l1_Ruby_Txt.text = 'X ' + String(this.localVars.l1_Player.rubiesCount);
            ruby.kill();
        };
        Level1Screen.prototype.collectCarrots = function (player, carrot) {
            this.localVars.l1_Player.carrotsCount++;
            this.assets.l1_Carrot_Txt.text = 'X ' + String(this.localVars.l1_Player.carrotsCount);
            carrot.kill();
        };
        Level1Screen.prototype.hitSnakes = function (player, snake) {
        ...
        Level1Screen.prototype.hitTurtles = function (player, turtle) {
            //console.log(player.body.touching.down);
            if (player.body.touching.down) {
        ...
        Level1Screen.prototype.resetPlayer = function () {
        ...
        Level1Screen.prototype.killSnake = function (bullet, snake) {
            //console.log(bullet);
            //console.log(snake);
            snake.animations.stop();
            snake.frame = 1;
        ...
        Level1Screen.prototype.killTurtle = function (bullet, turtle) {
            //console.log(bullet);
            //console.log(turtle);
            turtle.animations.stop();
            turtle.frame = 1;
        ...
        //-----------------------------------------------------------------------------------------------
        Level1Screen.prototype.openGameOverWindow = function () {
        ...
        Level1Screen.prototype.closeGameOverWindow = function () {
        ...
        //-----------------------------------------------------------------------------------------------
        Level1Screen.prototype.goExitClicked = function () {
            //console.log('goExitClicked');
            this.game.state.start('LevelsScreen');
        };
        Level1Screen.prototype.goPlayAgainClicked = function () {
            //console.log('goPlayAgainClicked');
            this.game.state.start('Level1Preloader');
        };
        //-----------------------------------------------------------------------------------------------s
        Level1Screen.prototype.testMe = function () {
            console.log('testMe');
        };
        return Level1Screen;
    }(Phaser.State));
    RabbitRunGame.Level1Screen = Level1Screen;
})(RabbitRunGame || (RabbitRunGame = {}));
//# sourceMappingURL=level1Screen.js.map